import { G as useRuntimeConfig, j as encodePath, a as buildAssetsURL, A as publicAssetsURL, e as defineRenderHandler, m as getQuery, c as createError, i as destr, q as getRouteRules, w as joinURL, p as getResponseStatusText, o as getResponseStatus, F as useNitroApp } from '../_/nitro.mjs';
...
const getServerEntry = () => import('../virtual/entry.mjs').then(function (n) { return n.o; }).then((r) => r.default || r);
...
const entryFileName = "BEamuPqU.js";
