import { d as _plugin_vue_export_helper_default, aj as vue_exports, a7 as useHead$1, R as server_renderer_exports } from '../virtual/entry.mjs';
import 'unhead/utils';
import 'vue';
...
//#region node_modules/.pnpm/nuxt@4.5.1_@babel+plugin-sy_ea81036c7f314471d0d56a1d48c253cc/node_modules/nuxt/dist/app/components/error-500.vue
var _sfc_main = {
	__name: "error-500",
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-0bce0d12><div class="max-w-520px text-center" data-v-0bce0d12><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-0bce0d12>${(0, server_renderer_exports.ssrInterpolate)(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-0bce0d12>${(0, server_renderer_exports.ssrInterpolate)(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-0bce0d12>${(0, server_renderer_exports.ssrInterpolate)(__props.description)}</p></div></div>`);
		};
	}
};
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.5.1_@babel+plugin-sy_ea81036c7f314471d0d56a1d48c253cc/node_modules/nuxt/dist/app/components/error-500.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var error_500_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-0bce0d12"]]);

export { error_500_default as default };
//# sourceMappingURL=error-500-Dtz7fwFv.mjs.map
