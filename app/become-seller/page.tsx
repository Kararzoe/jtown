...
export default function BecomeSellerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If we got a token, save it and apply as service provider
      if (data.token) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-white dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Your seller profile has been created. We'll review and approve it within 24 hours.
            </p>
            <a
              href="/"
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {loading ? t('loading') : t('registerShop')}
              </motion.button>

              <p className="text-center text-sm text-gray-500 dark:text-gray-400">
                We'll review your application and approve it within 24 hours
              </p>
            </form>
          </motion.div>
          ...
          >
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-1">List Services</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Showcase your skills to thousands</p>
            </div>
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm">
              <div className="text-4xl mb-3">💬</div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-1">Get Contacted</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Buyers reach you directly</p>
            </div>
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-sm">
              <div className="text-4xl mb-3">💰</div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-1">Grow Your Business</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Reach thousands daily in Jos</p>
            </div>
          </motion.div>
        </div>
      </div>
