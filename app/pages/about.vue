<template>
  <div class="min-h-screen bg-white dark:bg-gray-900 py-16 px-4">
    <div class="max-w-3xl mx-auto">
      <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-8">About JosMKT</h1>
      <div class="space-y-6 text-gray-600 dark:text-gray-400">
        ...
        <p>To make it easy for everyone in Jos to find reliable, professional service providers — from plumbers and electricians to bakers and photographers — all in one place.</p>

        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">What We Do</h2>
        ...
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Our Coverage</h2>
        <p>We cover all areas in Jos including Bukuru, Rayfield, Terminus, Lamingo, Tudun Wada, Nassarawa, Hwolshe, Old Airport, Polo, British, Sukuwa, and surrounding areas in Plateau State.</p>
